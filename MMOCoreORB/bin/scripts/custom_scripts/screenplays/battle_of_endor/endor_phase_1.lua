...
function EndorPhase1ScreenPlay:spawnMobiles()
  ...
  spawnMobile("endor", "emperors_hand", 600, 750, 18, 903, 180, 0)
  spawnMobile("endor", "emperors_hand", 1800, 755, 18, 903, 180, 0)
  spawnMobile("endor", "emperors_hand", 600, 750, 18, 926, 0, 0)
  spawnMobile("endor", "emperors_hand", 1800, 755, 18, 926, 0, 0)

  spawnMobile("endor", "emperors_hand", 600, 764, 18, 912, 180, 0)
  spawnMobile("endor", "emperors_hand", 1800, 764, 18, 917, 180, 0)
  spawnMobile("endor", "emperors_hand", 600, 741, 18, 912, -90, 0)
  spawnMobile("endor", "emperors_hand", 1800, 741, 18, 917, -90, 0)
