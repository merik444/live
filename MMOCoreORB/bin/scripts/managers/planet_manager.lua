...
corellia = {
	...
	planetTravelPoints = {
		...
		{name = "Coronet Shuttle A", x = -25.6704, z = 28, y = -4409.7847, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
	...
	planetObjects = {
		{templateFile = "object/tangible/beta/beta_terminal_wound.iff", ox = 0, oy = -0.664289, oz = 0, ow = 0.747476, x = -136.516, z = 28, y = -4733.98, parentid = 0},
...
lok = {
	...
	planetTravelPoints = {
		...
		{name = "Infinity Arena", x = 685, z = 12, y = 2160, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1}
	},
...
naboo = {
	...
	planetObjects = {
		...
		--{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = -0.0116238, oz = 0, ow = 0.999932, x = 5193.14, z = -192, y = 6680.25, parentid = 0},
		 --{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0.734569, oz = 0, ow = -0.686427, x = -5011.04, z = 8.19243, y = 2877, parentid = 0}  
		 {templateFile = "object/tangible/beta/beta_terminal_wound.iff", ox = 0, oy = 0, oz = 0, ow = 1, x = -5044.1, z = 8.6832, y = 2839, parentid = 0},   -- Highgarden New Player Terminal
		 --{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0.734569, oz = 0, ow = 0.678535, x = -5011.04, z = 8.19243, y = 2877, parentid = 0},  -- HG Frog
