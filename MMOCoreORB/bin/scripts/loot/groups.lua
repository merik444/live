...
includeFile("groups/weapon/mandalorian_pistol.lua")
includeFile("groups/weapon/mandalorian_lightsaber.lua")
includeFile("groups/weapon/mandalorian_sword.lua")
...
includeFile("groups/landspeeder_ab1.lua")
includeFile("groups/sith_speeder.lua")
...
-- Lightsaber Pike
includeFile("groups/weapon/lightsaber_pike.lua")
