...
DBUser = "swgemu"
DBPass = "xxxxxxxx"
DBSecret = "xxxxxxxxxxxx" -- Change this! This value should be unique and of reasonable length.
...
TrePath = "/infinity/trefiles"
--TrePath = "/mnt/disk2/trefiles"
TreFiles = {
  "infinity_custom.tre",
  "mtg_patch_022.tre",
  "mtg_planets.tre",
